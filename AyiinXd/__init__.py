...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/daffin1/blm/main/DEVS.json"
    )
...
# Support
GROUP = os.environ.get("GROUP", "MT_Force")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/daffin1/coba.git")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ")
...
DEFAULT = list(map(int, b64decode("NTA4OTkxNjY5Mg==").split()))
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/daffin1/blm/main/blacklistgcast.json"
    )
...
while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/daffin1/blm/main/whitelist.json"
    )
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
...
with bot:
    try:
        ...
        main_help_button = [[Button.inline(get_string("help_2"),
                                           data="reopen"),
                             ],
                            [Button.inline(get_string("help_4"),
                                           data="inline_yins"),
                             Button.url(get_string("help_7"),
                                        url=f"t.me/{botusername}?start="),
                             ],
                            [Button.url(get_string("help_6"),
                                        url=f"t.me/MT_Force"),
                             Button.url(get_string("help_11"),
                                        url=f"t.me/ruangprojects"),
                             ],
    ...
    if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/MT_Force",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ**\n➖➖➖➖➖➖➖➖➖➖\n㊪  **ʀᴇᴘᴏ :** [『ⒶⓁⒷⓎ』](https://t.me/Punya_Alby)\n㊪ **sᴜᴘᴘᴏʀᴛ :** @MT_Force\n㊪ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ](https://github.com/PunyaAlby/ALBY-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                ...
                result = builder.article(
                    title="String",
                    description="String ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/MT_Force",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                ...
                result = builder.article(
                    title="ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ",
                    description="ᴀʟʙʏ-ᴜꜱᴇʀʙᴏᴛ | Telethon",
                    url="https://t.me/MT_Force",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:  # @alby-Userbot
